...
DRIVER = {
  ...
  verification_notes = "Ported from a reference implementation. Telemetry is not yet verified against live hardware on an FTW site; control is disabled because the former 0 W command released the inverter to self-consumption instead of holding the battery at zero.",
  connection_defaults = {
    port    = 502,
    unit_id = 1,
  },
